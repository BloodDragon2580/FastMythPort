...
FastMythPort[L["Wrath of the Lich King"]] = {
    {id = 1254555, type = 'spell', name = 'Path of Unyielding Blight', unobtainable = false}
}
...
FastMythPort[L["Mists of Pandaria"]] = {
    ...
    {id = 131228, type = 'spell', name = 'Path of the Black Ox', unobtainable = false},
...
FastMythPort[L["Warlords of Draenor"]] = {
    ...
    {id = 1254557, type = 'spell', name = 'Path of the Crowning Pinnacle', unobtainable = false}
}
...
FastMythPort[L["Legion"]] = {
    ...
    {id = 1254551, type = 'spell', name = 'Path of Dark Dereliction', unobtainable = false}
}
